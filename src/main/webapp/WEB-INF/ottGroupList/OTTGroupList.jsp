...
<link rel="stylesheet" href="<c:url value='/css/base.css' />"
	type="text/css">
<link rel="stylesheet" href="<c:url value='/css/ottGroupList.css' />"
	type="text/css">
</head>
<body>
	<!-- 헤더 포함 -->
		...
		<div
			...
			<div class="fixed-header">
				<img src="<c:url value='${ottService.image}' />"
					alt="${ottService.name}" class="logo"> <a
					href="<c:url value='/ottGroup/show/createForm?ottId=${ottService.id}' />"
					class="btn-room-create">방 개설하기</a>
			</div>
		</div>
