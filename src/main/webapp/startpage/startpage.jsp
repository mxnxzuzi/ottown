...
<head>
  ...
  <link rel="stylesheet" href="<%= request.getContextPath() %>/css/start_style.css">
</head>
<body>
<header>
  <nav class="navbar">
    ...
    <ul class="nav-user">
      <li><a href="<%= request.getContextPath() %>/loginForm/login.jsp">로그인</a></li>
      <li><a href="<%= request.getContextPath() %>/signupForm/signup.jsp">회원가입</a></li>
    </ul>
  </nav>
</header>
<main>
...
<script>
  ...
  button.addEventListener('click', function() {
    window.location.href = '<%= request.getContextPath() %>/loginForm/login.jsp';
  });
</script>
</body>
</html>